...
/**
 * The SAME Gherkin specs driven over HTTP (black-box, through a real WebServer). Excludes the
 * {@code @saga} feature, whose purge arrives over the broker, not HTTP — that path is covered in
 * the account-deletion slice. Mirrors the multi-entry-point BDD of microservice-security.
 */
@Suite
