...
- **Kompensacja sagi offboardingu (ADR 0007) — WDROŻONE 2026-08-08.** Ten serwis był ostatnim
  ...
  Otwarte:
  - **Alarm zaległości nie ma reguły w Prometheusie** — jest gauge i linia w logu, nie ma alertu
    (bliźniaczo w memes i comments). Zgubione domknięcie to problem RODO, więc powinien być.
