...
/**
 * The second persistence port, for the second access axis. {@link CollectionRepository} is the
 ...
 *
 * <p><b>Why a separate port and not one more method on {@link CollectionRepository}.</b> The two are
 ...
 * detail of {@code JdbcCollectionRepository}, not a reason to fuse the ports.
 */
